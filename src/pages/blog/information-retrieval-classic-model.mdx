...
import classicIrModelPng from '../../assets/classic-ir-model.png'
import { Picture } from 'astro:assets'

<InformationRetrievalPreface />

<Picture src={classicIrModelPng} alt="Classic information retrieval model" widths={[1210]} aspectRatio="1210:747" />
